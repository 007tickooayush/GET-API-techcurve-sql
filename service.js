...
const getService = async (data) => {
    ...
    //    "totalPages": 3,
    //    "totalCount": 25,
        return { status: 200, result: result.result, currentPage : data.currentPage, pageSize: data.pageSize, totalCount: result.count, totalPages: Math.ceil(result.count/data.pageSize)};
    } catch (err) {
